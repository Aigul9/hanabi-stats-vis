...
function verify() {
  ...
  var radioRecords = document.getElementById("radioRecords"); // const radioFull = document.getElementById("radioFull");

  var textPlayer = document.getElementById("textPlayer").value;
  var textRecords = document.getElementById("textRecords").value; // if (
...
window.onload = function () {
  ...
  document.getElementById("radioRecords").addEventListener("change", handleChange); // document.getElementById("radioFull").addEventListener("change", handleChange);
